...
- seats:
  ...
  A data frame of x and y positions, row numbers and angles (usually the
  output from the seats function).
...
- formula:
  ...
  A formula with the party name column on the left and the count column
  on the right. Think of the twiddle symbol as "got".

- colours:

  A vector of colours. If missing a random rainbow is used. This may
  cause Green parties to show as red.
